...
namespace ROPTLIB{
	...
	public:
		/*Sparse square matrix times a dense tall thin matrix
		The sparse n by n matrix B is stored as three arrays:
			B for entries
		...
		*/
		static void SPBtimesX(const double *B, const unsigned long long *ir, const unsigned long long *jc, integer nzmax, const double *X, integer n, integer p, double *result);
