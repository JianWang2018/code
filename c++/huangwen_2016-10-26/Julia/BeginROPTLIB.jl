...
cd("/home/whuang/Documents/Linux_ROPTLIB/ROPTLIB")

# import the directory of the header files of Julia
addHeaderDir("/home/whuang/julia-0.5.0-rc3/include/julia/", kind=C_System) 
...
function DriverJuliaOPT(inHandles, inSparams, inMparams, inHasHHR, inX0)
	...
	resultptr = @cxx DriverJuliaProb(jpcpp"FunHandles"(inHandles), jpcpp"SolverParams"(inSparams), jpcpp"ManiParams"(inMparams), inHasHHR, pointer(inX0), length(inX0))
	...
	lseries = convert(Int64, (resultlength - lx0 - 12) / 3)
