...
namespace ROPTLIB{
	...
	void Matrix::SPBtimesX(const double *B, const unsigned long long *ir, const unsigned long long *jc, integer nzmax, const double *X, integer n, integer p, double *result)
	{
